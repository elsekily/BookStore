    ...
    public partial class IntialModel : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InvoiceBooks", x => x.ID);
                    table.ForeignKey(
                        name: "FK_InvoiceBooks_Books_BookID",
                        column: x => x.BookID,
                        principalTable: "Books",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InvoiceBooks_Invoices_InvoiceID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceBooks_BookID",
                table: "InvoiceBooks",
                column: "BookID");

            migrationBuilder.CreateIndex(
                name: "IX_InvoiceBooks_InvoiceID",
                table: "InvoiceBooks",
                column: "InvoiceID");
